...
RUN --mount=type=cache,id=s/f5e0a71c-b2d6-4a30-8c34-6b2d7ce25c42-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/f5e0a71c-b2d6-4a30-8c34-6b2d7ce25c42-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/f5e0a71c-b2d6-4a30-8c34-6b2d7ce25c42-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
